    ...
    <div className="widgetLg">
      ...
      <table className="widgetLgTable">
        ...
        <tr className="widgetLgTr">
          <td className="widgetLgUser">
            <img
              ...
              className="widgetImg"
            />
            <span className="widgetLgName">Amal Perera</span>
          </td>
        ...
        <tr className="widgetLgTr">
          <td className="widgetLgUser">
            <img
              src="https://emi9d8rzue7.exactdn.com/wp-content/uploads/2022/09/Andor-Avatar.png?strip=all&lossy=1&ssl=1"
              alt=""
              className="widgetImg"
            />
            <span className="widgetLgName">Amal Perera</span>
        ...
        <tr className="widgetLgTr">
          <td className="widgetLgUser">
            <img
              src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTlXhvEaxM6ZbYdXwTtNWjYUaIIn4xZJ96KRwTzZFjgM-tWHMWck_w_jCBgCBz5YssDJq4&usqp=CAU"
              alt=""
              className="widgetImg"
            />
            <span className="widgetLgName">Amal Perera</span>
